...
trait DataArrays
{
    private function approachArray()
    {
        $approach_data = [
			'bg-color' => [
				'approach'=>'#59595c',
			...
			'image' => [
				'approach'=>'',
				'committed'=>'bonsai.png',
				'listen'=>'chair.png',
				'love'=>'ice-cream.png',
				'team'=>'dragon_ball.png',
				'honest'=>'mirror.png',
				'impact'=>'bee.png',
			],
		];
        return [
			'approach'=>
				[
				'bg-color'=>$approach_data['bg-color']['approach'],
				'class_id' => '1',
				'text-align'=>'left',
				'description' => __('transcript.approach_desc'),
				'text-big'=> __('transcript.approach'),
				'column1' => 12,
				'start_bold' => true,
				'header-class'=>'screen-size',
				'image' => $approach_data['image']['approach'],
				'add-on' => '<a href="#" data-scrollto=".2Desktop" data-offset="0" class="dark one-page-arrow"><br/><i class="icon-angle-down infinite animated fadeInDown"></i></a>'
				],
			'committed'=>
		    	[
				'bg-color'=>$approach_data['bg-color']['committed'],
				'class_id' => '2',
				'text-align'=>'right',
				'description' =>  __('transcript.committed_desc'),
				'text-big'=>  __('transcript.committed'),
				'column1' => 6,
				'start_bold' => false,
				'image' => $approach_data['image']['committed']
				],
			'listen'=>
				[
				'bg-color'=>$approach_data['bg-color']['listen'],
				'class_id' => '3',
				'text-align'=>'left',
				'description' => __('transcript.listen_desc'),
				'text-big'=> __('transcript.listen'),
				'column1' => 7,
				'start_bold' => true,
				
				'image' => $approach_data['image']['listen']
				],
			'love'=>
				 [
				'bg-color'=>$approach_data['bg-color']['love'],
				'class_id' => '4',
				'text-align'=>'right',
				'description' => __('transcript.love_desc'),
				'text-big'=> __('transcript.love'),
				'column1' => 7,
				'start_bold' => true,
				'image' => $approach_data['image']['love']
				],
			'team'=>
				[
				'bg-color'=>$approach_data['bg-color']['team'],
				'class_id' => '5',
				'text-align'=>'left',
				'description' => __('transcript.team_desc'),
				'text-big'=> __('transcript.team'),
				'column1' => 6,
				'start_bold' => false,
				'image' => $approach_data['image']['team']
				],
			'honest'=>
				[
				'bg-color'=>$approach_data['bg-color']['honest'],
				'class_id' => '6',
				'text-align'=>'right',
				'description' => __('transcript.honest_desc'),
				'text-big'=> __('transcript.honest'),
				'column1' => 6,
				'start_bold' => false,
				'image' => $approach_data['image']['honest']
				],
			'impact'=>
				[
				'bg-color'=>$approach_data['bg-color']['impact'],
				'class_id' => '7',
				'text-align'=>'left',
				'description' => __('transcript.impact_desc'),
				'text-big'=> __('transcript.impact'),
				'column1' => 7,
				'start_bold' => false,				
				'image' => $approach_data['image']['impact']
				]
			]
        ;
    }
    private function clientsArray()
    {
        return [
            "hh",			
            "canon",
    ...
    private function expertiseArray(){
        $expertise_data = [
			'bg-color' => [
				'expertise'=>'#174154',
				'advertising'=>'#8560a8',
			...
			'image' => [
				'expertise'=>'',
				'advertising'=>'claw.png',
				'creative'=>'mortar.png',
				'digital'=>'bug.png',
				'events'=>'chocolate-cake.png',
        ...
        return [
			'expertise' => 
				[
					'bg-color'=>$expertise_data['bg-color']['expertise'],
					'class_id' => '1',
					'text-align'=>'left',
					'description' => '',
					'text-big'=>  __('transcript.expertise'),
					'column1' => 12,
					'start_bold' => true,
					'image' => $expertise_data['image']['expertise'],
					'header-class'=>'screen-size',
					'add-on' => '<a href="#" data-scrollto=".2Desktop" data-offset="0" class="dark one-page-arrow arrow-offset"><i class="icon-angle-down infinite animated fadeInDown"></i></a>'
				],
			'advertising' => 
				[
					'bg-color'=>$expertise_data['bg-color']['advertising'],
					'class_id' => '2',
					'text-align'=>'right',
					'description' => __('transcript.advertising_desc'),
					'text-big'=> __('transcript.advertising'),
					'content-wrap-nopad' => 'style="padding:0px !important"',
					'col-h-100' => 'h-100',
					'column1' => 6,
					'start_bold' => true,
					'header-class'=>'full-screen',
					'image' => $expertise_data['image']['advertising']
				],
			'creative' => 	
				[
					'bg-color'=>$expertise_data['bg-color']['creative'],
					'class_id' => '3',
					'text-align'=>'left',
					'description' => __('transcript.creative_desc'),
					'text-big'=> __('transcript.creative'),
					'column1' => 7,
					'start_bold' => true,
					'image' => $expertise_data['image']['creative']
				],
			'digital' => 
				[
					'bg-color'=>$expertise_data['bg-color']['digital'],
					'class_id' => '4',
					'text-align'=>'right',
					'description' => __('transcript.digital_desc'),
					'text-big'=> __('transcript.digital'),
					'column1' => 7,
					'start_bold' => true,
					'image' => $expertise_data['image']['digital']
				],
			'events' => 	
				 [
					'bg-color'=>$expertise_data['bg-color']['events'],
					'class_id' => '5',
					'text-align'=>'left',
					'description' => __('transcript.events_desc'),
					'text-big'=> __('transcript.events'),
					'column1' => 6,
					'start_bold' => true,
					'image' => $expertise_data['image']['events']
                 ]
        ];
    }
    /**
     * Helper for data in \App\Helper\Helper paramWork()
     *
     * @return array
     */
    private function workArray()
    {
        return [
